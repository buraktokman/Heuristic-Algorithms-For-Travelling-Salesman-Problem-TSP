...
CONFIG = {'tsp_file' : 'Workspace/src/com/company/output_nearest.tsp'}
...
def main():
	...
	plt.savefig('visualize_nearest.png', dpi=400)

	# ROTATE PNG 90-degrees COUNTER-CLOCK WISE
	im = Image.open('visualize_nearest.png')
	out = im.rotate(90, expand=True)
	out.save('visualize_nearest.png')
